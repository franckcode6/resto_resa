...
<body>
	...
	<main class="container">
		<h2 class="my-4">${sessionScope.professionnal.firstName} ${sessionScope.professionnal.lastName} - Modification ${restaurant.name}</h2>
		...
		<form method="post" enctype="multipart/form-data"
			...
			<div class="mb-3">
				...
				<textarea rows="5" class="form-control" id="description" name="DESCRIPTION">${restaurant.description}</textarea>
			</div>
			...
			<div class="mb-3">
				...
				<input class="form-control" id="noAddress" name="NOADDRESS" value="${restaurant.address.noAddress}">
			</div>
			
			<div class="mb-3">
				<label for="address" class="form-label">Adresse</label>
				<input class="form-control" id="address" name="ADDRESS" value="${restaurant.address.address}">
			</div>
			
			<div class="mb-3">
				<label for="postalCode" class="form-label">Code postal</label>
				<input class="form-control" id="postalCode" name="POSTALCODE" value="${restaurant.address.postalCode}">
			</div>
			
			<div class="mb-4">
				<label for="city" class="form-label">Ville</label>
				<input class="form-control" id="city" name="CITY" value="${restaurant.address.city}">
			</div>
